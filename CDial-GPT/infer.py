...
def build_input_from_segments(history, reply, tokenizer, with_eos=True):
    ...
    sequence = [sequence[0]] + [[speaker2 if i % 2 else speaker1] + s for i, s in enumerate(sequence[1:])]#每一段话都加上[100]
    instance = {}
...
def main():
    ...
    parser.add_argument("--datapath", type=str, default="data/test.json", help="Path of the dataset.")
    parser.add_argument("--out_path", type=str, default="result.txt", help="Path of response generated.")
    parser.add_argument("--model_checkpoint", type=str, default="runs/Jul19_15-46-00_titan4-dutir", help="Path, url or short name of the model")

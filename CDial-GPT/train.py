...
def train():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="pretrained/GPT", help="Path or URL of the model")
    ...
    parser.add_argument("--data_path", type=str, default="data/MDiadata_1.json",
    ...
    if args.local_rank in [-1, 0] and args.n_epochs > 0:
        os.rename(os.path.join(tb_logger.writer.logdir, checkpoint_handler._saved[-1][1]),
                  os.path.join(tb_logger.writer.logdir, WEIGHTS_NAME))  # _saved[-1][1][-1]
        tb_logger.close()
